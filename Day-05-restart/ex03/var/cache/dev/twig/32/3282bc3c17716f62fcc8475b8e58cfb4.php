...
";
        // line 13
        if ((($tmp = (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 13, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 14
            yield "    <p><strong>";
...
";
    ...
    {
        return array (  114 => 17,  111 => 16,  105 => 14,  103 => 13,  98 => 11,  94 => 10,  90 => 9,  85 => 6,  75 => 5,  58 => 3,  41 => 1,);
    }
...
<a href=\"{{ path('ex03_select') }}\">Voir les utilisateurs</a>
